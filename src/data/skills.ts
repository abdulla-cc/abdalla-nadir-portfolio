...
export const achievements: Achievement[] = [
  ...
  { icon: LineChart, title: '9 Projects', description: 'Full-stack software, offline-first apps, analytics, ML, NLP, and AI engineering — from dashboards to deployed products.' },
