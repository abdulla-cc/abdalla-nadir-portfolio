...
export const certifications: Certification[] = [
  { title: 'Data Visualization and Dashboards with Excel and Cognos', issuer: 'IBM via Coursera · Sep 2026', badge: 'Verified', icon: Award },
  ...
  { title: 'Introduction to Responsible AI', issuer: 'Google Cloud · Jul 2026', badge: 'Verified', icon: ShieldCheck },
]
