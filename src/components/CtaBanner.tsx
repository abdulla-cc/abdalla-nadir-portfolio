...
export function CtaBanner() {
  return (
    <div className="mx-auto max-w-[1200px] px-6 py-12 md:px-8 lg:px-12">
      <Reveal>
        <div className="relative overflow-hidden rounded-[20px] border border-[rgba(242,202,80,0.20)] bg-gradient-to-br from-[#0a0e27] to-[#1a2847] px-6 py-11 text-center md:rounded-[28px] md:px-14 md:py-[72px]">
          ...
          <p className="mx-auto mb-8 max-w-[560px] text-[17px] text-[#aeb9d4]">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-[#f2ca50] px-[22px] py-[13px] text-sm font-bold text-[#0a0e27] transition-all hover:-translate-y-0.5 hover:bg-[#d4af37] hover:shadow-[0_12px_28px_rgba(242,202,80,0.25)]"
          >
